...
[![Scarf.io pulls](https://scarf.sh/installs-badge/linuxserver-ci/linuxserver%2Fmsedge?color=94398d&label-color=555555&logo-color=ffffff&style=for-the-badge&package-type=docker)](https://scarf.sh/gateway/linuxserver-ci/docker/linuxserver%2Fmsedge)
...
| Parameter | Function |
| :----: | --- |
| `3000` | Edge desktop gui. |
| `3001` | HTTPS Edge desktop gui. |
